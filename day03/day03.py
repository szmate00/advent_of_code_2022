...
def partTwo(inFile: str) -> int:
    ...
    with open(inFile) as f:
        lines = []
        for idx, line in enumerate(f):                                          # almost the same as before
